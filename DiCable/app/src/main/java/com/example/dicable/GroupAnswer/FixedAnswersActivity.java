...
public class FixedAnswersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fixed_answers);
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                count =  (int)snapshot.child("fixed").getChildrenCount() + 1;
                collect(snapshot);
    ...
    public void goMain(View v) {
        Intent intent = new Intent(FixedAnswersActivity.this, MainActivity.class);
        startActivity(intent);
    }

    public void goToAll(View v) {
        Intent intent = new Intent(FixedAnswersActivity.this, AllAnswersActivity.class);
        startActivity(intent);
    }

    public void goToWatched(View v) {
        Intent intent = new Intent(FixedAnswersActivity.this, WatchedAnswersActivity.class);
        startActivity(intent);
    }

    public void goToStatistic(View v) {
        Intent intent = new Intent(FixedAnswersActivity.this, StatisticActivity.class);
        startActivity(intent);
    }
    ...
    public void Logout() {
        ...
        Intent intent = new Intent(FixedAnswersActivity.this, AuthActivity.class);
        startActivity(intent);
    }
}