...
public class WatchedAnswersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_watched_answers);
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                count =  (int)snapshot.child("watched").getChildrenCount() + 1;
                collect(snapshot);

                Intent intent = getIntent();

                for (Integer w :watched) {
                    Answer db_answer = snapshot.child("basic").child(String.valueOf(w)).getValue(Answer.class);
...
//        }
    ...
    public void goMain(View v) {
        Intent intent = new Intent(WatchedAnswersActivity.this, MainActivity.class);
        startActivity(intent);
    }

    public void goToAll(View v) {
        Intent intent = new Intent(WatchedAnswersActivity.this, AllAnswersActivity.class);
        startActivity(intent);
    }

    public void goToFixed(View v) {
        Intent intent = new Intent(WatchedAnswersActivity.this, FixedAnswersActivity.class);
        startActivity(intent);
    }

    public void goToStatistic(View v) {
        Intent intent = new Intent(WatchedAnswersActivity.this, StatisticActivity.class);
        startActivity(intent);
    }
    ...
    public void Logout() {
        ...
        Intent intent = new Intent(WatchedAnswersActivity.this, AuthActivity.class);
        startActivity(intent);
    }
